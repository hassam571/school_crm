...
<head>
    ...
    <style>
        :root {
        --primary-color: {{ $systemSettings['theme_primary_color'] ?? '#800000' }};
        --secondary-color: {{ $systemSettings['theme_secondary_color'] ?? '#800000' }};
                    ...
                    <div class="col-xl-6 mx-auto">
                        ...
                        <div class="auth-form-light rounded-lg text-left p-5">
                            <div class="brand-logo text-center">
                                ...
                                @else
                                    <img class="img-fluid w-25" src="{{ url('assets/logo.png') }}" alt="logo">
                                @endif
