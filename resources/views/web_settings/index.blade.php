...
@section('script')
    <script>
        ...
        {
            if (value == 1) {
                $('#theme_primary_color').val('#800000');
                $('.theme_primary_color').asColorPicker('val', '#800000');
            }

            if (value == 2) {
                $('#theme_secondary_color').val('#800000');
                $('.theme_secondary_color').asColorPicker('val', '#800000');
            }
            if (value == 3) {
