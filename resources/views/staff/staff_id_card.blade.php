...
<head>
    ...
    <style>
        * {
        ...
        .footer {
            background-color: {{ $settings['staff_footer_color'] ?? '#800000' }};
            color: {{ $settings['staff_header_footer_text_color'] ?? 'black' }};
            position: fixed;
            width: 100%;
            padding: 2px 0px;
            ...
            <table class="table full-width">
                <tr class="header">
                    <th class="school-logo">
                        ...
                        @else
                            <img height="40" src="{{ public_path('assets/logo.png') }}" alt="">
                        @endif
                    </th>
            ...
            <table class="table full-width">
                ...
                <tr>
                    <th colspan="2">
                        ...
                        @else
                            <img height="40" style="padding-top: 5px" src="{{ public_path('assets/logo.png') }}" alt="">
                        @endif
                    </th>
                </tr>
                <tr>
